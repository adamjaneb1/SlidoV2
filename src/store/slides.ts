...
export const useSlidesStore = defineStore('slides', {
  ...
  getters: {
    ...
    // Merge items with trigger condition "with previous animation" to same position in sequence
    // Add auto-next flag to previous item for items with trigger condition "after previous animation"
