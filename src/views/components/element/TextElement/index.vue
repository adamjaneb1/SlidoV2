  ...
  >
    ...
    >
      ...
      >
        ...
        <!-- When font size is too large and line height is too small, text overflow occurs making drag areas unselectable, so these nodes are added to prevent this -->
...
// Monitor text element size changes, update height to vuex when height changes
// If height changes during scaling operation, wait until scaling completes before updating
