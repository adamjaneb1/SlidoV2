...
const tabs: TabItem[] = [
  { key: 'in', label: 'Entry', color: '#68a490' },
...
// Animation info for currently selected element
...
// Sync data after dragging to change animation order
...
// Update element animation duration
...
// Update element animation and run preview
...
// Add element animation and run preview
...
// Remove the mask layer 600ms after opening the animation selection panel, otherwise quickly hovering to preview after opening the panel will cause jitter
