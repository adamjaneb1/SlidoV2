<template>
  <div class="rich-text-base">
    ...
    <div class="row">
      <ButtonGroup style="flex: 1;" passive>
        <Button first style="flex: 1;" v-tooltip="'Decrease indent'" @click="emitRichTextCommand('indent', '-1')"><IconIndentLeft /></Button>
      ...
      <div style="width: 10px;"></div>
      <ButtonGroup style="flex: 1;" passive>
        <Button first style="flex: 1;" v-tooltip="'Increase indent'" @click="emitRichTextCommand('indent', '+1')"><IconIndentRight /></Button>
