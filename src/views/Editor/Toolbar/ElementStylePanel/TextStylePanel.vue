...
// Note: There is an unknown bug where if the text box height increases after bolding text,
// the canvas viewport positioning will be incorrect. Therefore, when executing preset style
// commands, place the bold command as early as possible to avoid bolding after font size increases.
const presetStyles = [
  {
    label: 'Heading 1',
    style: {
...
// Send rich text formatting commands (batch)
