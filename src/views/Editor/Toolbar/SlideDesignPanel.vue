<template>
  <div class="slide-design-panel">
    ...
    <div class="background-gradient-wrapper" v-if="background.type === 'gradient'">
      ...
      <div class="row">
        <div style="width: 40%;">Current Color:</div>
    ...
    <div class="row">
      ...
      <Select 
        ...
        :options="[
          ...
          { label: 'A3/A4 Paper', value: 0.70710678 },
    ...
    <div class="row">
      <Button style="flex: 1;" @click="themeStylesExtractVisible = true">Extract Theme from Slides</Button>
    </div>
    ...
    <div class="theme-list">
      ...
      >
        <div class="theme-item-content">
          ...
          <div class="btns">
            <Button type="primary" size="small" @click="applyPresetThemeToSingleSlide(item)">Apply</Button>
            <Button type="primary" size="small" style="margin-top: 3px;" @click="applyPresetThemeToAllSlides(item)">Apply Globally</Button>
          </div>
        </div>
      </div>
    </div>
...
// Set background mode: solid, image, gradient
