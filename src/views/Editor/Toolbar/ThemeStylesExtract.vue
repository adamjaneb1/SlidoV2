<template>
  <div class="theme-styles-extract">
        ...
        <div class="values">
          <div class="value-wrap" v-for="(item, index) in themeStyles.themeColors" :key="item">
            ...
            <div class="handler">
              ...
              <div class="config-btn" @click="selectedIndex.themeColor = index">Select</div>
              <div class="config-btn" @click="updateTheme({ themeColor: item }); selectedIndex.themeColor = index">Apply to Theme</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="btns">
      <Button class="btn" type="primary" @click="updateAllThemes()">Save Selected Config as Theme</Button>
    </div>
  </div>
</template>
