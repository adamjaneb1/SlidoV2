    ...
    <div class="configs">
      ...
      <div class="row">
        ...
        <div class="config-item">
          <Switch v-model:value="ignoreMedia" v-tooltip="'Audio/video is ignored by default during export. If your slides contain audio/video elements and you want to include them in the PPTX file, you can disable the [Ignore Audio/Video] option, but note this will significantly increase export time.'" />
        </div>
      </div>
      <div class="row">
      ...
      <div class="tip" v-if="!ignoreMedia">
        Note: 1. Supported export formats: avi, mp4, mov, wmv, mp3, wav; 2. Cross-origin resources cannot be exported.
      </div>
    </div>
    <div class="btns">
