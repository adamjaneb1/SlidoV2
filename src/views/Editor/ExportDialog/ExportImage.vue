    ...
    <div class="configs">
      ...
      <div class="row">
        ...
        <div class="config-item">
          <Switch v-model:value="ignoreWebfont" v-tooltip="'Web fonts are ignored by default during export. If you have used web fonts in your slides and want to preserve their styles, you can disable the [Ignore Web Fonts] option, but note this will increase export time.'" />
        </div>
      </div>
    </div>

    <div class="btns">
      <Button class="btn export" type="primary" @click="expImage()">Export Images</Button>
